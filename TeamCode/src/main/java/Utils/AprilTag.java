...
public class AprilTag {
    ...
    public Pose2d getRobotPosition(List<AprilTagDetection> currentDetections) {
        ...
        AprilTagPoseFtc aprilTagDetection = currentDetections.get(0).ftcPose;
        Pose2d robotPose = new Pose2d(
                aprilTagDetection.x,
                aprilTagDetection.y,
                new Rotation2d(aprilTagDetection.yaw)
        );
        return robotPose;
    }
}
